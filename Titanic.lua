...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,114518657,1231111}
...
if hash or Bot(msg) or DevTitanic(msg) or DevBotsIs(msg) then    
return true  
else  
return false  
end  
...
if hash or Bot(msg) or DevTitanic(msg) or DevBot(msg) or DevBotsIs(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevTitanic(msg) or DevBot(msg) or DevBotsIs(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevTitanic(msg) or DevBot(msg) or BasicConstructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevTitanic(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevTitanic(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevTitanic(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
if DevTitanice(user_id) == true then
var = true
elseif DevTitanic(user_id) == true then
var = true
...
var = true  
elseif tonumber(user_id) == tonumber(1231111) then
var = true  
...
elseif DevTitanice(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
function Titanic_Started_Bot(msg,data) -- بداية العمل
if msg then
...
local Titanic_Msg = database:sismember(bot_id.."List:Filter:text"..msg.chat_id_,text) 
if Titanic_Msg then    
...
function Function_Titanic(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Titanic, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Titanic, nil)
return false 
end
...
if text == ("الثانويين") and DevTitanic(msg) then
...
if text == ("مسح قائمه العام") and DevTitanic(msg) then
database:del(bot_id.."GBan:User")
database:del(bot_id.."Gmute:User")
send(msg.chat_id_, msg.id_, "\n܁༯┆ تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and DevTitanic(msg) then
...
if text == ("قائمه العام") and DevTitanic(msg) then
...
if text == ("قائمه كتم عام") and DevTitanic(msg) then
...
if text == ("المطورين") and DevTitanic(msg) then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTitanic(msg) then
function Function_Titanic(extra, result, success)
...
if result.sender_user_id_ == tonumber(1231111) then
send(msg.chat_id_, msg.id_, "܁༯┆ لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if text and text:match("^حظر عام @(.*)$")  and DevTitanic(msg) then
...
if result.id_ == tonumber(1231111) then
send(msg.chat_id_, msg.id_, "܁༯┆ لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevTitanic(msg) then
...
if userid == tonumber(1231111) then
send(msg.chat_id_, msg.id_, "܁༯┆ لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if text == ("كتم عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTitanic(msg) then
function Function_Titanic(extra, result, success)
if result.sender_user_id_ == tonumber(Id_Sudo) then
send(msg.chat_id_, msg.id_, "܁༯┆ لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور البوت الاساسي \n")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevTitanic(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevTitanic(msg) then
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTitanic(msg) then
function Function_Titanic(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevTitanic(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevTitanic(msg) then
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTitanic(msg) then
function Function_Titanic(extra, result, success)
...
if text and text:match("^اضف مطور @(.*)$") and DevTitanic(msg) then
...
if text and text:match("^اضف مطور (%d+)$") and DevTitanic(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."Sudo:User", userid)
Reply_Status(msg,userid,"reply","܁༯┆ تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTitanic(msg) then
function Function_Titanic(extra, result, success)
...
if text and text:match("^حذف مطور @(.*)$") and DevTitanic(msg) then
...
if text and text:match("^حذف مطور (%d+)$") and DevTitanic(msg) then
...
local Titanicrt = database:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if Titanicrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"܁༯┆ العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "X04XX")..")".."\n܁༯┆ تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif Titanicrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"܁༯┆ العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "X04XX")..")".."\n܁༯┆ تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif Titanicrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"܁༯┆ العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "X04XX")..")".."\n܁༯┆ تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Manager"..msg.chat_id_,result.sender_user_id_)  
elseif Titanicrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"܁༯┆ العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "X04XX")..")".."\n܁༯┆ تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
if result.id_ then
local Titanicrt = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if Titanicrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"܁༯┆ العضو ↺ ["..result.title_.."](t.me/"..(text1[3] or "X04XX")..")".."\n܁༯┆ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✫> العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'X04XX')..') ~'
...
usertext = '\n✫ العضو > ['..result.title_..'](t.me/'..(username or 'X04XX')..')'
status  = '\n✫ تم تقيده لمدة  { '..TextEnd[2]..' '..TextEnd[3]..'}'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁༯┆  العضو ↺ ['..data.first_name_..'](t.me/'..(data.username_ or 'Titanic')..') '
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevTitanic(msg) then 
...
if text == ("ردود المطور") and DevTitanic(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n܁༯┆ قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevTitanic(msg) then 
send(msg.chat_id_, msg.id_,"܁༯┆  ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevTitanic(msg) then 
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'X04XX')..')'
...
if text == 'كشف' and tonumber(msg.reply_to_message_id_) > 0 and
                    not database:get(bot_id .. 'Titanic:Lock:ID:Bot' .. msg.chat_id_) then
                    function Function_Titanic(extra, result, success)
                        tdcli_function({
                            ID = "GetUser",
...
if text == "تفعيل المغادره" and DevTitanic(msg) then   
database:del(bot_id.."Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"܁༯┆ تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevTitanic(msg) then  
database:set(bot_id.."Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "܁༯┆ تم تعطيل مغادرة البوت") 
return false 
end
if text == (database:get(bot_id.."Name:Bot") or "الجبار") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."Name:Bot") or "الجبار")
local namebot = {
...
if database:get(bot_id.."Status:Bc") and not DevTitanic(msg) then 
...
if text == "تفعيل الاذاعه" and DevTitanic(msg) then  
database:del(bot_id.."Status:Bc") 
send(msg.chat_id_, msg.id_,"\n܁༯┆ تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevTitanic(msg) then  
...
if text == "تنظيف المشتركين" and DevTitanic(msg) then
...
if text == "تنظيف الكروبات" and DevTitanic(msg) then
...
if text == ("تحديث السورس") and DevTitanic(msg) then  
send(msg.chat_id_,msg.id_,'܁༯┆ تم التحديث')
os.execute('rm -rf Titanic.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/Titanic-DeV/Titanic/main/Titanic.lua')
os.execute('wget https://raw.githubusercontent.com/Titanic-DeV/Titanic/main/start.lua')
dofile('Titanic.lua')  
return false
end
if text == "راسلني" then
...
zh = https.request('https://Titanic-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n✫️ : قائمه الزخرفه \n — — — — — — — — — \n"
i = 0
...
gk = https.request('https://Titanic-api.ml/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
...
ge = https.request('https://Titanic-api.ml/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.ok.hso)
end
if text == 'السيرفر' and DevTitanic(msg) then 
...
data,res = https.request('https://Titanic-api.ml/infoInstagram.php?username='..URL.escape(Textni)..'')
if res == 200 then
...
data,res = https.request('https://Titanic-api.ml/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
...
if text == "غنيلي" then
data,res = https.request('https://Titanic-api.ml/audios.php')
if res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- Titanic sᴏᴜʀᴄʀ .',url="t.me/X04XX"}},
}
local msg_id = msg.id_/2097152/0.5
...
st = https.request('https://Titanic-api.ml/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://Titanic-api.ml/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if text == 'تفعيل البوت الخدمي' and DevTitanic(msg) then  
database:del(bot_id..'Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'܁༯┆ تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and DevTitanic(msg) then  
database:set(bot_id..'Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'܁༯┆ تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevTitanic(msg) then
...
if text == 'جلب نسخه احتياطيه' and DevTitanic(msg) then
local list = database:smembers(bot_id..'Chek:Groups')  
local memo = database:smembers(bot_id..'UsersBot')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
...
if text == 'الملفات' and DevTitanic(msg) then
t = '܁༯┆ جميع الملفات : \n — — — — — — — — — \n'
i = 0
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
...
if DevTitanic(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Titanic-DeV/files_Titanic/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n܁༯┆ اهلا بك في متجر ملفات الجبار\n܁༯┆ يوجد في المتجر ملف الردود\n܁༯┆ يتم ادراج الملفات في التحديثات القادمه \n — — — — — — — — — \n"
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevTitanic(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Titanic-DeV/files_Titanic/main/files_Titanic/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevTitanic(msg) then
...
if text == "مسح جميع الملفات" and DevTitanic(msg) then
os.execute("rm -fr Files/*")
send(msg.chat_id_,msg.id_,"܁༯┆ تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevTitanic(msg) then
...
if text == 'حذف كليشه المطور' and DevTitanic(msg) then
database:del(bot_id..'Text_Dev')
send(msg.chat_id_, msg.id_,'܁༯┆  تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevTitanic(msg) then
...
if text == 'رفع النسخه الاحتياطيه' and DevTitanic(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevTitanic(msg) then
dofile("Titanic.lua")  
send(msg.chat_id_, msg.id_, "܁༯┆ تم التحديث")
end
if text == 'السورس' or text == 'سورس' or text == 'ياسورس' or text == 'يا سورس' then  
local url,res = https.request('https://Titanic-api.ml/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'܁༯┆ شترك في قناة السورس اولآ @X04XX .')   
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ Titanic sᴏᴜʀᴄʀ\n\n[-  Titanic ᴄʜᴀɴɴᴇʟ  .](http://t.me/X04XX)\n\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](http://t.me/X04XX)\n\n[-  Titanic ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](http://t.me/IZlZ7I)\n\n[-  ʙᴏᴛ Titanic .](http://t.me/rriebot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '܁༯┆ Titanic sᴏᴜʀᴄʀ .',url="t.me/X04XX"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/X04XX&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevTitanic(msg) then
...
if not DevTitanic(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Filter"..msg.sender_user_id_) then
...
if DevTitanic(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,'܁༯┆ [تحديثات البوت](t.me/X04XX) .\n - [قناه السورس](t.me/X04XX) .')
return false  
end
...
if text and text:match("^- تغير الاشتراك ✫ .$") and DevTitanic(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '܁༯┆ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^- تغير رساله الاشتراك ✫ .$") and DevTitanic(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '܁༯┆ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ✫ ." and DevTitanic(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "܁༯┆ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^- تعين قناة الاشتراك ✫ .$") and DevTitanic(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '܁༯┆ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "- تفعيل الاشتراك الاجباري ✫ ." and DevTitanic(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "- تعطيل الاشتراك الاجباري ✫ ." and DevTitanic(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "܁༯┆ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "- الاشتراك الاجباري ✫ ." and DevTitanic(msg) then  
...
if text == ("قائمه المكتومين العام ✫") and DevTitanic(msg) then
local list = database:smembers(bot_id.."Gmute:User")
...
inline = {
{{text = '܁༯┆  - Titanic sᴏᴜʀᴄʀ  .',url='http://t.me/X04XX'}},
}
...
local Name_Bot = (database:get(bot_id.."Name:Bot") or "الجبار")
...
------------------------------------------------------------------------
if text then
local Titanic_Msg = database:sismember(bot_id.."List:Filter:text"..result.chat_id_,text) 
if Titanic_Msg then    
