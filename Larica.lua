...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1573309498,114518657}
...
if hash or Bot(msg) or DevLarica(msg) or DevBotsIs(msg) then    
return true  
else  
return false  
end  
...
if hash or Bot(msg) or DevLarica(msg) or DevBot(msg) or DevBotsIs(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevLarica(msg) or DevBot(msg) or DevBotsIs(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevLarica(msg) or DevBot(msg) or BasicConstructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevLarica(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevLarica(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevLarica(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
local Larica_Msg = database:sismember(bot_id.."List:Filter:text"..msg.chat_id_,text) 
if Larica_Msg then    
...
if text == ("قائمه كتم عام") and DevLarica(msg) then
...
if text == ("كتم عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevLarica(msg) then
function Function_Larica(extra, result, success)
if result.sender_user_id_ == tonumber(Id_Sudo) then
send(msg.chat_id_, msg.id_, "⟥┆ لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور البوت الاساسي \n")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevLarica(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevLarica(msg) then
...
local Laricart = database:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if Laricart == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"⟥┆ العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "LARICATEAM")..")".."\n⟥┆ تم رفعه "..RTPA.." هنا\n")
...
if result.id_ then
local Laricart = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if Laricart == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"⟥┆ العضو ↺ ["..result.title_.."](t.me/"..(text1[3] or "LARICATEAM")..")".."\n⟥┆ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
usertext = '\n⟥ العضو > ['..result.title_..'](t.me/'..(username or 'LARICATEAM')..')'
status  = '\n⟥ تم تقيده لمدة  { '..TextEnd[2]..' '..TextEnd[3]..'}'
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'LARICATEAM')..')'
...
if text == 'كشف' and tonumber(msg.reply_to_message_id_) > 0 and
                    not database:get(bot_id .. 'Larica:Lock:ID:Bot' .. msg.chat_id_) then
                    function Function_Larica(extra, result, success)
                        tdcli_function({
                            ID = "GetUser",
...
if database:get(bot_id.."Status:Bc") and not DevLarica(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/Titanic-DeV/Larica/main/Larica.lua')
os.execute('wget https://raw.githubusercontent.com/Titanic-DeV/Larica/main/start.lua')
dofile('Larica.lua')  
return false
end
if text == "راسلني" then
...
zh = https.request('https://Larica-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n⟥️ : قائمه الزخرفه \n — — — — — — — — — \n"
i = 0
...
gk = https.request('https://Larica-api.ml/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
...
ge = https.request('https://Larica-api.ml/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.ok.hso)
end
if text == 'السيرفر' and DevLarica(msg) then 
...
data,res = https.request('https://Larica-api.ml/infoInstagram.php?username='..URL.escape(Textni)..'')
if res == 200 then
...
data,res = https.request('https://Larica-api.ml/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
...
if text == "غنيلي" then
data,res = https.request('https://Larica-api.ml/audios.php')
if res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- Larica sᴏᴜʀᴄʀ .',url="t.me/LARICATEAM"}},
}
local msg_id = msg.id_/2097152/0.5
...
st = https.request('https://Larica-api.ml/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://Larica-api.ml/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if DevLarica(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Titanic-DeV/files_Larica/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Titanic-DeV/files_Larica/main/files_Larica/"..file)
if res == 200 then
...
local url,res = https.request('https://Larica-api.ml/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'⟥┆ شترك في قناة السورس اولآ @LARICATEAM .')   
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ Larica sᴏᴜʀᴄʀ\n\n[-  Larica ᴄʜᴀɴɴᴇʟ  .](http://t.me/LARICATEAM)\n\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](http://t.me/LARICATEAM)\n\n[-  Larica ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](http://t.me/BBBBRR)\n\n[-  ʙᴏᴛ Larica .](http://t.me/rriebot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⟥┆ Larica sᴏᴜʀᴄʀ .',url="t.me/LARICATEAM"}},
}
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevLarica(msg) then
...
if not DevLarica(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Filter"..msg.sender_user_id_) then
...
send(msg.chat_id_, msg.id_,'⟥┆ [تحديثات البوت](t.me/LARICATEAM) .\n - [قناه السورس](t.me/LARICATEAM) .')
return false  
end
...
if text == ("قائمه المكتومين العام ⟥") and DevLarica(msg) then
local list = database:smembers(bot_id.."Gmute:User")
...
inline = {
{{text = '⟥┆  - Larica sᴏᴜʀᴄʀ  .',url='http://t.me/LARICATEAM'}},
}
...
------------------------------------------------------------------------
if text then
local Larica_Msg = database:sismember(bot_id.."List:Filter:text"..result.chat_id_,text) 
if Larica_Msg then    
